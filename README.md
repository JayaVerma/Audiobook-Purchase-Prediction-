...
1. Developed a deep learning algorithm predicting customers’ next purchase in an Audiobook App, using 2 years of activity data. 
2. Implemented a deep learning network model with ReLU and softmax activations, employing the Adam optimizer. 
3. Achieved a commendable 82% accuracy, showcasing strong data analysis and predictive modeling skills.
